/* MQTT (over TCP) and Button & LED Example */
...
#define LED_GPIO 2           // GPIO pin for the LED (you can change this to your desired pin)
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_DATA:
        ...
        // Check if the message is "ON" or "OFF" to control the LED
...
/*
 * @brief Task to publish message when button is pressed
 */
static void button_task(void *arg)
{
    ...
    if (gpio_get_level(BUTTON_GPIO) == 1) {
        int msg_id = esp_mqtt_client_publish(client, "KMITL/SIET/65030096/Button", "Button Pressed", 0, 1, 0);
        ESP_LOGI(TAG, "Button pressed, published message, msg_id=%d", msg_id);
    }
